/* trace:src/script/config/require-config.js */
var require = require || {
	debug: true,
	baseUrl: G.CDN_ORIGIN + '/yuanxiao/script',
	paths: {
	...
	resolveUrl: function(url) {
		var baseUrl = G.CDN_ORIGIN + '/yuanxiao/script/';
...
/* trace:src/script/lib/yom/require/require-lite.js */
/**
